...
#ifndef _GxEPD2_750c_Z08_Custom_H_
#define _GxEPD2_750c_Z08_Custom_H_

#include <GxEPD2_EPD.h>

class GxEPD2_750c_Z08_Custom : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_750c_Z08_Custom(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
